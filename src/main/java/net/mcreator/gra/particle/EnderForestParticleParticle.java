...
package net.mcreator.gra.particle;
...
public class EnderForestParticleParticle extends GraModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public EnderForestParticleParticle(GraModElements instance) {
		super(instance, 106);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("ender_forest_particle"));
	}
