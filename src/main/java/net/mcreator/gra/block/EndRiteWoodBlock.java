...
public class EndRiteWoodBlock extends GraModElements.ModElement {
	@ObjectHolder("gra:end_rite_wood")
	public static final Block block = null;
	public EndRiteWoodBlock(GraModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(EndRiteWoodBlock.block, (int) (1));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EndRiteWoodBlock.block, (int) (1)));
		}
	}
}
