...
public class WastedHoeItem extends GraModElements.ModElement {
	@ObjectHolder("gra:wasted_hoe")
	public static final Item block = null;
	public WastedHoeItem(GraModElements instance) {
		super(instance, 58);
	}
