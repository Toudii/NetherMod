...
package net.mcreator.gra.world.biome;
...
public class EnderForestBiome extends GraModElements.ModElement {
	public static Biome biome;
	public EnderForestBiome(GraModElements instance) {
		super(instance, 106);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						...
						.setParticle(new ParticleEffectAmbience(EnderForestParticleParticle.particle, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EndriteGrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("gra:ender_forest"));
			}
		}
	}
	@Override
