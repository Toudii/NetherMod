...
package net.mcreator.gra.world.structure;
...
public class EndRiteStemSmall1Structure extends GraModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public EndRiteStemSmall1Structure(GraModElements instance) {
		super(instance, 97);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
							...
							if (blockAt.getBlock() == EndriteGrassBlock.block.getDefaultState().getBlock())
								blockCriteria = true;
							if (!blockCriteria)
								continue;
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("gra", "endrite_stem_small1"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("end_rite_stem_small_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("gra:end_rite_stem_small_1"), configuredFeature);
		}
	}
	@SubscribeEvent
